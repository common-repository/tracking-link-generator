...
<div class="alti_tlg_promote_container">
	...
	<p><span class="dashicons dashicons-arrow-right-alt2"></span><a target="_blank" class="alti_promote_btn" href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=MJ3NXGRTA34KG&lc=FR&item_name=<?php echo $get_from; ?>&no_note=0&no_shipping=1&currency_code=USD"><strong>Donate</strong> <span class="alti_promote_paypal_svg"><?php echo $paypal_svg; ?></span></a> to encourage me updating this plugin!</p>
	</div>
		...
		<?php foreach ($related_plugins as $related_plugin): ?>	
			<?php if( $related_plugin[0] != $get_from ) { ?>
				<div class="alti_promote_plugin">
					<a href="plugin-install.php?tab=search&type=term&s=alticreation+<?php echo urlencode($related_plugin[0]); ?>" title="<?php echo $related_plugin[1]; ?>"><img src="https://plugins.svn.wordpress.org/<?php echo $related_plugin[0]; ?>/assets/icon-128x128.png" alt="<?php echo $related_plugin[1]; ?>"></a>
